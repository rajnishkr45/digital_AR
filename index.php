                ...
                <div class="container px-lg-5">
                    <div class="row g-5 align-items-end">
                        <div class="col-lg-6 text-center text-lg-start">
                            <h1 class="text-white mb-4 animated slideInDown">A Digital Agency of Intelligent & Creative
                                People</h1>
                            <p class="text-white pb-3 animated slideInDown">
                                We are a team of innovative thinkers and strategic creators dedicated to transforming
                                your digital presence. From branding to development, we deliver solutions that drive
                ...
                <div class="row g-4">
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="feature-item bg-light rounded text-center p-4">
                            ...
                            <p class="m-0">Boost your online presence with strategic campaigns, targeted ads, and
                                content that engages your audience and drives results.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="feature-item bg-light rounded text-center p-4">
                            ...
                            <p class="m-0">Improve your search rankings and domain authority with expert keyword
                                strategies and high-quality backlink building.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="feature-item bg-light rounded text-center p-4">
                            ...
                            <p class="m-0">We create stunning, responsive websites and applications tailored to your
                                brand’s goals and your users’ needs.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <h1 class="mb-5">#1 Digital Solution with 3+ Years of Proven Experience</h1>
                        <p class="mb-4">
                            We specialize in delivering impactful digital solutions that drive real results. With over 3
                            years of industry experience, our team blends creativity, strategy, and technology to help
            ...
            <div class="container py-5 px-lg-5">
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-lg-3 text-center wow fadeIn" data-wow-delay="0.3s">
                        ...
                        <h1 class="text-white mb-2" data-toggle="counter-up">11</h1>
            ...
            <div class="container py-5 px-lg-5">
                <div class="row justify-content-center">
                    <div class="col-lg-7 text-center">
                        ...
                        <p class="text-white mb-4">Stay updated with our latest news, offers, and design tips. Subscribe
                            to receive valuable insights straight to your inbox every week.</p>
